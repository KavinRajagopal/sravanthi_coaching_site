    ...
    <section className="bg-brand-elevated py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6">
        <ScrollReveal className="text-center mb-16 max-w-2xl mx-auto">
          <p className="text-brand-muted font-sans text-xs tracking-[0.3em] uppercase mb-4">Transformation</p>
        ...
        >
          {items.map((item, i) => (
            <motion.div
              ...
              className="bg-white p-8 group hover:bg-brand-elevated transition-colors duration-300"
            >
              ...
              <h3 className="font-display text-xl text-brand-text mb-3 font-light">{item.title}</h3>
