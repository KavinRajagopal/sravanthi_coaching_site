  ...
  fields: [
    ...
    { name: "subtitle", type: "text", defaultValue: "What makes every event special." },
    {
      ...
      defaultValue: [
        ...
        { title: "Bilingual — Telugu & English", description: "Fluent in both Telugu and English, seamlessly switching between languages for diverse audiences.", iconName: "Globe" },
